    ...
    <form action="" method="post">
        ...
        <ul>
            ...
            <li>
                ...
                <input type="text" name="namapanggung" id="namapanggung" required value="<?= $sgr["namaPanggung"]; ?>" autocomplete="off">
            </li>
            <li>
                <label for="kelahiran">Kelahiran :</label>
                <input type="text" name="kelahiran" id="kelahiran" required value="<?= $sgr["kelahiran"]; ?>" autocomplete="off">
            </li>
            <li>
                <label for="tempatlahir">Tempat Lahir :</label>
                <input type="text" name="tempatlahir" id="tempatlahir" required value="<?= $sgr["tempatLahir"]; ?>" autocomplete="off">
            </li>
            <li>
            ...
            <li>
                ...
                <input type="text" name="gambar" id="gambar" required value="<?= $sgr["gambar"]; ?>" autocomplete="off">
            </li>
            <li>
