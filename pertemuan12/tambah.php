    ...
    <form action="" method="post">
        <ul>
            ...
            <li>
                ...
                <input type="text" name="namapanggung" id="namapanggung" required autocomplete="off">
            </li>
            <li>
                <label for="kelahiran">Kelahiran :</label>
                <input type="text" name="kelahiran" id="kelahiran" required autocomplete="off">
            </li>
            <li>
                <label for="tempatlahir">Tempat Lahir :</label>
                <input type="text" name="tempatlahir" id="tempatlahir" required autocomplete="off">
            </li>
            <li>
            ...
            <li>
                ...
                <input type="text" name="instrumen" id="instrumen" autocomplete="off">
            </li>
            <li>
