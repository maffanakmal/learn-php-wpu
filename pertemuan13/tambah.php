    ...
    <form action="" method="post" enctype="multipart/form-data">
        <ul>
            ...
            <li>
                ...
                <input type="text" name="namapanggung" id="namapanggung" autocomplete="off">
            </li>
            <li>
                <label for="kelahiran">Kelahiran :</label>
                <input type="text" name="kelahiran" id="kelahiran" autocomplete="off">
            </li>
            <li>
                <label for="tempatlahir">Tempat Lahir :</label>
                <input type="text" name="tempatlahir" id="tempatlahir" autocomplete="off">
            </li>
            <li>
